  ...
  return (
    <div className='max-w-md mx-auto mt-16 bg-gradient-to-br from-white/3 to-white/2 p-8 rounded-2xl backdrop-blur'>
      ...
      <form className='grid gap-3' onSubmit={submit}>
        <input value={name} onChange={e=>setName(e.target.value)} placeholder='Full name' className='px-4 py-3 rounded-lg bg-white/3' />
        ...
        <button className='mt-2 px-6 py-3 rounded-lg bg-gradient-to-r from-ff-rose to-ff-gold text-black font-semibold'>Sign up</button>
      </form>
    </div>
  )
}
